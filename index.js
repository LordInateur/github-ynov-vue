var app = new Vue({
  ...
  data: {
    ...
    gitusers : [
      {pseudo : "LordInateur", repos : ["github-ynov-vue","SHI-FU-MI-clicker"], repoSelected:["github-ynov-vue"]},
      {pseudo : "benjaminbra", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Nair0fl", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "mathiasLoiret", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "thomaspich", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "TeofiloJ", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Grigusky", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Dakistos", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "mael61", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "KevinPautonnier", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "BenoitCochet", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "sfongue", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "ClementCaillaud", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "gfourny", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Mokui", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "AntoineGOSSET", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "etienneYnov", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Coblestone", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "AlexDesvallees", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "rudy8530", repos : ["github-ynov-vue"], repoSelected:[]},
      {pseudo : "Killy85", repos : ["github-ynov-vue"], repoSelected:[]},
